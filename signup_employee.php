...
<body>
<form method="post" action="form_submit_employee.php">
<div class="bg-image">
...
<div class="row_1" > 
			<h1><font color="black" face="Bradley Hand ITC">Employee's Information</font></h1> 
		</div>
...
<div class="columns">
  ...
  <div class="col_1" >
    ...
    <p><font color="black" face="Bradley Hand ITC">Name : <input type="text" name="name" value=""required></font></p></br>
	<p><font color="black" face="Bradley Hand ITC">Address : <input type="text" name="address" value=""></font></p></br>
	<p><font color="black" face="Bradley Hand ITC">Phone Number : <input type="tel" name="contact" placeholder="01XXXXXXXXX" pattern="[0-9]{11}" value=""required></font></p></br> 
